...
Each template module can supply a execution function, an optional type guard for
...
You can execute a template by passing in JSON via STDIN and getting the result
as STDOUT:
