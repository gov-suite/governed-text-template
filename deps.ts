...
export * as govnSvcHealth from "https://denopkg.com/gov-suite/governed-service-helpers@v0.3.0/health.ts";
export * as oakHelpers from "https://denopkg.com/gov-suite/governed-service-helpers@v0.3.0/oak.ts";
export * as govnSvcVersion from "https://denopkg.com/gov-suite/governed-service-helpers@v0.3.0/version.ts";
export * as inflect from "https://denopkg.com/shah/text-inflect@v1.0.4/mod.ts";
export * as interpolate from "https://denopkg.com/shah/text-interpolate@v1.0.7/mod.ts";
